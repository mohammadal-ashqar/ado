          ...
          <div class="col-lg-4 col-md-6 shuffle-item">
              <div class="project-item">
                ...
                <div class="project-hover bg-secondary px-4 py-3">
                  <a href="{{ route('adomedia.ar.portfolio',$i->id) }}" class="text-white h4">{{ $i->sections }}</a>
                  <a href="{{ route('adomedia.ar.portfolio',$i->id) }}"><i class="ti-link icon-xs text-white"></i></a>
                </div>
              </div>
            </div>
          @empty
