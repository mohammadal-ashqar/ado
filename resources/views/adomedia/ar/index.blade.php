        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 mx-auto text-center">
                    ...
                    <p class="lead">أن تكون شركتنا ذات بصمة مميزة في مشاريع عملائها حيث نتطلع لأفضل الخبــرات و
                        المهـــارات لنجاح جميع المشـــــــاريع .</p>
                    ...
                    <div class="col-lg-4 col-md-6 shuffle-item">
                        <div class="project-item">
                            ...
                            <div class="project-hover bg-secondary px-4 py-3">
                                <a href="{{ route('adomedia.portfolio', $i->id) }}"
                        ...
                        <article class="card">
                            ...
                            <div class="card-body p-0">
                                ...
                                <a href="{{ route('adomedia.blog', $i->id) }}"
                                    class="h4 card-title d-block my-3 text-dark hover-text-underline">{{ $i->title_ar }}</a>
                                <a href="{{ route('adomedia.blog', $i->id) }}" class="btn btn-transparent">
                                    المزيد...</a>
                            </div>
                        </article>
                    </div>
